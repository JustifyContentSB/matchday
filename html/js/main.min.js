...
"use strict";function matchSwiper(){new Swiper(".match__slider-container",{slidesPerView:"auto",spaceBetween:0,loop:!1,speed:500,navigation:{prevEl:".match__prev",nextEl:".match__next"}})}function lectureSwiper(){$(window).width()<1024&&new Swiper(".lecture__slider-container",{slidesPerView:"auto",spaceBetween:20,loop:!1,navigation:{nextEl:".lecture__next"}})}function memeSwiper(){new Swiper(".meme__slider-container",{slidesPerView:"auto",spaceBetween:26,loop:!1,navigation:{nextEl:".meme__next"},breakpoints:{1280:{slidesPerView:4,spaceBetween:40,slidesPerGroup:4}}})}function giftManSwiper(){new Swiper(".gift__slider-man .gift__slider-container",{slidesPerView:"auto",spaceBetween:10,loop:!1,navigation:{prevEl:".gift__slider-man .gift__prev",nextEl:".gift__slider-man .gift__next"}})}function giftWomanSwiper(){new Swiper(".gift__slider-woman .gift__slider-container",{slidesPerView:"auto",spaceBetween:10,loop:!1,navigation:{prevEl:".gift__slider-woman .gift__prev",nextEl:".gift__slider-woman .gift__next"}})}function navOpen(){$(".header__burger").on("click",function(e){e.preventDefault(),$(".header__nav").addClass("header__nav--active"),$("body").addClass("no-scroll")})}function navClose(){$(".header__nav-close").on("click",function(e){e.preventDefault(),$(".header__nav").removeClass("header__nav--active"),$("body").removeClass("no-scroll")})}$(document).ready(function(){matchSwiper(),lectureSwiper(),memeSwiper(),giftManSwiper(),giftWomanSwiper(),navOpen(),navClose()}),document.addEventListener("DOMContentLoaded",function(){var i=new Date("2022-02-09 18:00:00"),r=null;function a(e,t){return t[4<e%100&&e%100<20?2:[2,0,1,1,1,2][e%10<5?e%10:5]]}function e(){var e=i-new Date;e<=0&&clearInterval(r);var t=0<e?Math.floor(e/1e3/60/60)%24:0,n=0<e?Math.floor(e/1e3/60)%60:0,e=0<e?Math.floor(e/1e3)%60:0;o.textContent=t<10?"0"+t:t,l.textContent=n<10?"0"+n:n,s.textContent=e<10?"0"+e:e,o.dataset.title=a(t,["час","часа","часов"]),l.dataset.title=a(n,["минута","минуты","минут"]),s.dataset.title=a(e,["секунда","секунды","секунд"])}var o=document.querySelector(".timer__hours"),l=document.querySelector(".timer__minutes"),s=document.querySelector(".timer__seconds");e(),r=setInterval(e,1e3)});