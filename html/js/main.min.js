...
"use strict";function matchSwiper(){new Swiper(".match__slider-container",{slidesPerView:"auto",spaceBetween:0,loop:!1,speed:500,navigation:{prevEl:".match__prev",nextEl:".match__next"}})}function lectureSwiper(){$(window).width()<1024&&new Swiper(".lecture__slider-container",{slidesPerView:"auto",spaceBetween:20,loop:!1,navigation:{nextEl:".lecture__next"}})}function memeSwiper(){new Swiper(".meme__slider-container",{slidesPerView:"auto",spaceBetween:26,loop:!1,navigation:{prevEl:".meme__prev",nextEl:".meme__next"},breakpoints:{1280:{slidesPerView:4,spaceBetween:40,slidesPerGroup:4}}})}function giftManSwiper(){new Swiper(".gift__slider-man .gift__slider-container",{slidesPerView:"auto",spaceBetween:10,loop:!1,navigation:{prevEl:".gift__slider-man .gift__prev",nextEl:".gift__slider-man .gift__next"}})}function giftWomanSwiper(){new Swiper(".gift__slider-woman .gift__slider-container",{slidesPerView:"auto",spaceBetween:10,loop:!1,navigation:{prevEl:".gift__slider-woman .gift__prev",nextEl:".gift__slider-woman .gift__next"}})}function navOpen(){$(".header__burger").on("click",function(e){return e.preventDefault(),$(this).toggleClass("header__burger--active"),$(".header").toggleClass("header--active"),$(".header__nav").toggleClass("header__nav--active"),!1})}function menuScroll(){$(window).width()<1280?$(".header__anchor").click(function(){var e=$(this).attr("href"),e=$(e).offset().top-$(".header__inner").height()-140;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:e},800),!1}):$(".header__anchor").click(function(){var e=$(this).attr("href"),e=$(e).offset().top-$(".header__inner").height()-40;return jQuery("html:not(:animated),body:not(:animated)").animate({scrollTop:e},800),!1})}function music(){$(".music__toggle").on("click",function(e){e.preventDefault(),$(".music__inner").addClass("music__inner--active")}),$(".music__top-toggle").on("click",function(e){e.preventDefault(),$(".music__inner").toggleClass("music__inner--active")})}$(document).ready(function(){matchSwiper(),lectureSwiper(),memeSwiper(),giftManSwiper(),giftWomanSwiper(),navOpen(),music(),menuScroll()}),document.addEventListener("DOMContentLoaded",function(){var a=new Date("2032-02-12 18:00:00"),r=null;function i(e,t){return t[4<e%100&&e%100<20?2:[2,0,1,1,1,2][e%10<5?e%10:5]]}function e(){var e=a-new Date;e<=0&&clearInterval(r);var t=0<e?Math.floor(e/1e3/60/60)%24:0,n=0<e?Math.floor(e/1e3/60)%60:0,e=0<e?Math.floor(e/1e3)%60:0;c.textContent=t<10?"0"+t:t,o.textContent=n<10?"0"+n:n,l.textContent=e<10?"0"+e:e,c.dataset.title=i(t,["час","часа","часов"]),o.dataset.title=i(n,["минута","минуты","минут"]),l.dataset.title=i(e,["секунда","секунды","секунд"])}var c=document.querySelector(".timer__hours"),o=document.querySelector(".timer__minutes"),l=document.querySelector(".timer__seconds");e(),r=setInterval(e,1e3)});var track=document.getElementById("track"),trackArtist=document.getElementById("track-artist"),trackTitle=document.getElementById("track-title"),durationTime=document.getElementById("durationTime"),play=document.getElementById("play"),pause=document.getElementById("pause"),pause2=document.getElementById("pause2"),next=document.getElementById("next-track"),prev=document.getElementById("prev-track");trackIndex=0,tracks=["https://res.cloudinary.com/cbanlawi/video/upload/v1614140796/HarryStyles-WatermelonSugar_f5471p.mp3","https://res.cloudinary.com/cbanlawi/video/upload/v1614144520/Justin_Bieber-Yummy_vercib.mp3","https://res.cloudinary.com/cbanlawi/video/upload/v1614186705/Loud_Luxury_ft._Brando_-_Body_fm7cdr.mp3"],trackArtists=["Harry Styles","Justin Bieber","Loud Luxury ft. Brando"],trackTitles=["Watermelon Sugar","Yummy","Body"];var playing=!0;function pausePlay(){playing=playing?(play.style.display="none",pause.style.display="block",track.play(),!1):(pause.style.display="none",play.style.display="block",track.pause(),!0)}function pausePlay2(){pause.style.display="none",play.style.display="block",track.pause(),playing=!0}function nextTrack(){trackIndex++,trackIndex>tracks.length-1&&(trackIndex=0),track.src=tracks[trackIndex],trackArtist.textContent=trackArtists[trackIndex],trackTitle.textContent=trackTitles[trackIndex],playing=!0,pausePlay()}function prevTrack(){trackIndex--,trackIndex<0&&(trackIndex=tracks.length-1),track.src=tracks[trackIndex],trackArtist.textContent=trackArtists[trackIndex],trackTitle.textContent=trackTitles[trackIndex],playing=!0,pausePlay()}function progressValue(){durationTime.textContent=formatTime(track.duration)}function formatTime(e){var t=Math.floor(e/60),e=Math.floor(e-60*t);return e<10&&(e="0".concat(e)),"".concat(t,":").concat(e)}play.addEventListener("click",pausePlay),pause.addEventListener("click",pausePlay),pause2.addEventListener("click",pausePlay2),track.addEventListener("ended",nextTrack),next.addEventListener("click",nextTrack),prev.addEventListener("click",prevTrack),setInterval(progressValue,500);for(var controller=new ScrollMagic.Controller,hearts=document.querySelectorAll(".match__person-heart__img"),i=0;i<hearts.length;i++)new ScrollMagic.Scene({triggerElement:hearts[i],offset:50,triggerHook:.9}).setClassToggle(hearts[i],"together").addTo(controller);